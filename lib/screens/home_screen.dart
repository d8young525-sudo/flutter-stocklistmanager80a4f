        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildPatchItem('🔐', 'v3.5.5: 비밀번호 찾기 기능', 
                '비밀번호를 잊어버리셨나요? 로그인 화면에서 "비밀번호를 잊으셨나요?" 클릭 → 계정 이메일 주소 입력 → 비밀번호 재설정 링크를 메일로 받아보실 수 있습니다.'),
              _buildPatchItem('🚢', '입항일정표 내장 적용', 
                '재고현황표만 업로드하면 입항일정이 자동으로 표시됩니다! 2024년 4월 ~ 2026년 1월 생산분 입항일정 총 298개 조합 (1,352개 일정)이 앱에 내장되어 있습니다.'),
